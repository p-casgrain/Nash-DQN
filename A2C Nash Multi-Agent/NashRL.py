...
if __name__ == '__main__':
    ...
    num_sim = 30000          # Number of Simulations
    ...
    # Supposed to be = 1 x (c1 + c2 + c3 + mu). Note: Need to make more robust
    parameter_number = 4
    ...
    torch.save(nash_agent.action_net.state_dict(),"Action_Net_single3")
    torch.save(nash_agent.value_net.state_dict(),"Value_Net_single3")